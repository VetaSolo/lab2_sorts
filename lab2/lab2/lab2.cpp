...
int main()
{
    ...
    int* array_1 = nullptr, * array_2 = nullptr;
    int max = Get_max();
    cout << "Max : " << max << endl;
    clock_t begin, end;
    double sec;
    ...
    {
        begin = clock();
        array_2 = Get_array(max, i);
        QuickSort(array_2, 0, i - 1);
        end = clock();
        sec = ((double)end - (double)begin) / CLOCKS_PER_SEC;
        cout << "Time of QuickSort " << i << " elements " << sec << "sec" << endl;
        delete[] array_2;
        array_2 = nullptr;
    }
    ...
    {
        begin = clock();
        array_1 = Get_array(max, i);
        InsertSort(array_1, i);
        end = clock();
        sec = ((double)end - (double)begin) / CLOCKS_PER_SEC;
        cout << "Time of InsertionSort " << i << " elements " << sec << "sec" << endl;
        delete[] array_1;
        array_1 = nullptr;
    }
    return 0;
